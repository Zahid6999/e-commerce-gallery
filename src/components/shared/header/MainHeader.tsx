      ...
      <div className="main-container">
        <div className="flex items-center gap-4 justify-start">
          ...
          <div className="flex items-center gap-4">
            <button
              className="w-10 h-10 border-2 border-black/5 rounded-full flex items-center justify-center hover:bg-gray-50 hover:scale-105 cursor-pointer transition-all duration-200"
              aria-label="User Account">
              <Image src={user} alt="user" />
            </button>
            <button
              className="w-10 h-10 border-2 border-black/5 rounded-full flex items-center justify-center hover:bg-gray-50 hover:scale-105 cursor-pointer transition-all duration-200 relative"
